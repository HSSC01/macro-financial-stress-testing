...
MACRO_PROCESSED_PATH = "data/processed/uk_macro_quarterly.parquet"
MACRO_META_PATH = "data/processed/uk_macro_quarterly.meta.json"
MACRO_RAW_DIR = "data/raw/macro"

DEFAULT_GROWTH_TRANSFORM = "qoq"

UK_MACRO_SERIES = {
    GDP_GROWTH: {
        "source": "ons_timeseries",
        "dataset": "ukea",
        "series_id": "abmi",
        "transform": DEFAULT_GROWTH_TRANSFORM,
        "unit_scale": 1e-3,
        "units_hint": "£m_cvm_sa"
    },
    ...
    HOUSE_PRICE_GROWTH: {
    "source": "ons_ukhpi_excel",
    "worksheet": "1",
    "geography": "United Kingdom",
    "frequency": "M",
    "aggregate_to": "Q",
    "aggregation": "mean",
    "seasonal_adjustment": "quarterly",
    "transform": "qoq",
    "raw_units": "index_nsa"
    },

    # BoE IADB series codes (already rates/yields)
    POLICY_RATE: {
        "source": "boe_iadb",
        "series_code": "ZZZZZZZ",  # Bank Rate series code
        "transform": "level",
        "units_hint": "%"
    },
    ...
    GILT_10Y: {
        "source": "boe_iadb",
        "series_code": "AAAAAAA",  # 10y gilt yield series code
        "transform": "level",
        "units_hint": "%"
    },
}